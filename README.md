...
| `annotation_manually.xlsx`      | Excel workbook with one tab per sample, used during the double-blind human annotation phase, after manual annotation                       |
...
> 📁 [Google Drive — annotated dataset](https://drive.google.com/drive/folders/1jBOm3cPYQTAB5KSv0IhnJkhRuzOUmlA0?usp=sharing)
...
| `tournament_pairings.json` | Maps each batch request ID to its metadata (categories, fight index, round index, joke texts, positions). Not committed due to size                                                                                                                  |
...
Beyond its role as the object of study, Claude (Anthropic) was used in the development of this project's website and as a coding assistant.
